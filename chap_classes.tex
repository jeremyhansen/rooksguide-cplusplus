...
% This section was initially named ``Constructors and Destructors'' -- we should probably include destructors at some point
...
Which of the following is the correct way to initialize the variables from the \Code{struct} above?
  ...
  \begin{enumerate}
	\item \Code{personInfo info = \{"Michael", 1996, 3, 24, "sixteen"\};}
	\item \Code{personInfo info = \{"Michael", 1996, March, 24, 16\};}
	\item \Code{personInfo info = \{"Michael", 1996, "March", 24, 16\};}
	\item \Code{struct info = \{"Michael", 1996, "March", 24, 16\};}
  \end{enumerate}
\end{enumerate}
