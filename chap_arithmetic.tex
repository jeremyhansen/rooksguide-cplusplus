...
For example, \Code{(4)(3)}, which we might expect to mean ``4 times 3'' does not mean the same as \Code{4~*~3}, the correct syntax. 
The expression \Code{(4)(3)} results in a syntax error and will not compile. 
The compiler returns an error message like this: 

\Code{'error: '4' cannot be used as a function.'}
...
% Mention preference for ++A vs A++, temporary variables and such
